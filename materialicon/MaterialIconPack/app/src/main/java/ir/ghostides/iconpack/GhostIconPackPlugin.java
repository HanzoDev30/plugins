...
/**
 * Ghost Icon Pack — custom file icons for GhostIDE.
 *
 ...
 */
public final class GhostIconPackPlugin implements GhostPlugin {
  ...
  public void activate(PluginContext context) {
    ...
    context.getLogger().info("Ghost Icon Pack activated.");
  }
