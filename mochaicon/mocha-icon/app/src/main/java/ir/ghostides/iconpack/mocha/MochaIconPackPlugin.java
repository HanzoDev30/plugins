package ir.ghostides.iconpack.mocha;
...
/**
 * Mocha Icon — Catppuccin Mocha file icons for GhostIDE.
 *
 ...
 */
public final class MochaIconPackPlugin implements GhostPlugin {
  ...
  public void activate(PluginContext context) {
    ...
    context.getLogger().info("Mocha Icon activated.");
  }
